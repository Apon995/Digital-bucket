...
function Navbar() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 w-full bg-[#635fc7] z-50 transition-all duration-300 ${
          navbackground ? "bg-[#635fc7] shadow-md" : "bg-transparent"
        }`}
      >
        <div className="container mx-auto px-4 py-3">
              ...
              <div className="flex items-center space-x-6">
                {[
                  ...
                  <NavLink
                    ...
                    to={item.path}
                    className={({ isActive }) =>
                      `text-white font-medium tracking-wide transition-all duration-300 hover:text-blue-100 ${
                        isActive
          ...
          <motion.div
            id="sidebar"
            className={`md:hidden fixed top-16 left-0 w-full h-screen bg-[#635fc7] transform transition-all duration-500 ease-in-out ${
